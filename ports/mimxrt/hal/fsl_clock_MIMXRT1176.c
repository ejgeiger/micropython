...
status_t CLOCK_CalcArmPllFreq(clock_arm_pll_config_t *config, uint32_t freqInMhz) {
    ...
    /*
     * ARM_PLL  (156Mhz - 2496Mhz configurable )
...
status_t CLOCK_CalcAvPllFreq(clock_av_pll_config_t *config, uint32_t freqInMhz) {
    ...
    /*
     * AUDIO_PLL/VIDEO_PLL  (20.3125MHZ--- 1300MHZ configurable )
 ...
 *          - \b true Freeze the tune at the current tuned value and the oscillator runs at the frozen tune value.
